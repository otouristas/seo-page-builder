...
- **26 desktop/mobile browser checks pass** in the current production-build suite, with two duplicate-metadata mobile skips and two isolated-service tests skipped because those services are stopped. They cover public sitemap routes, canonical metadata, all 17 Markdown articles, all nine demo sections, accessibility, keyboard/reduced motion, editing/export, learning search/filter/recovery, full-screen menu focus/scroll behavior, research demo controls, SERP editing/preview/history/export, related-question handoff and unauthenticated denial.
...
**Vercel only** is the confirmed hosting requirement for previews, production and rollback. The owner merged the initial rebuild through [PR #4](https://github.com/otouristas/seo-page-builder/pull/4), then merged the navigation, knowledge and research changes through [PR #5](https://github.com/otouristas/seo-page-builder/pull/5) on 8 September 2026 at 21:26 UTC. The resulting main commit is `13c4e020ee271b07bf716a394557b44dc386e56e`. The owner also merged release documentation through PR #6. The SERP Studio update is on `codex/serp-studio`. `archive/rankframe-baseline` preserves original source commit `c498f40a5db320f427218f748a81c7eca6c0db22` for reference. No ranksushi.com DNS change was made.
