...
The earlier baseline preview at https://ranksushi-9sgrgondh-otouristas-projects.vercel.app has its eight checks recorded in `artifacts/qa/deployed-preview-routes.json`. The baseline production rebuild at https://ranksushi-7am4rmxjo-otouristas-projects.vercel.app remains assigned to https://ranksushi.vercel.app; its eight route checks are retained separately in `artifacts/qa/deployed-routes.json`. The new learning/research application is currently a review preview, not promoted production.
